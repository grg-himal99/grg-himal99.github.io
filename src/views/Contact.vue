    ...
    <v-layout row justify-center align-center wrap class="mt-4 pt-2">
      <v-flex xs12 sm12 md6 lg6 xl6>
        ...
        <div class="py-4 subheading font-weight-bold">
          ...
          <span>Himal@</span>
          <span class="green--text">Gurung.com</span>
        </div>
        <div class="py-4 subheading font-weight-bold">
      ...
      <v-flex xs12 sm12 md6 lg6 xl6>
        ...
        <form method="POST" action="https://formspree.io/Himal@Gurung.com">
          <v-text-field
            name="name"
            color="green"
  ...
  metaInfo: {
    ...
    meta: [
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      {
        name: 'description',
        content:
          "Himal Gurung's Contact Doboj Bosnia and Herzegovina Freelance Get in Touch ContactMe"
      },
      { charset: 'utf-8' },
